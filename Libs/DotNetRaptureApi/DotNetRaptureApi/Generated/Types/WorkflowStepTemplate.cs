...
public class WorkflowStepTemplate   {
    [DataMember (Name="workflowStepTemplateURI")]
    public string workflowStepTemplateURI { get; set; }
    ...
    [DataMember (Name="outputTransitionNames")]
    public List<string> outputTransitionNames { get; set; }
