...
%\end{lstlisting}
\input{api/decision/getAllWorkflows}
...
%\end{lstlisting}
\input{api/decision/getWorkflowChildren}
...
%\end{lstlisting}
\input{api/decision/getWorkOrderChildren}
...
%\end{lstlisting}
\input{api/decision/putWorkflow}
...
%\end{lstlisting}
\input{api/decision/getWorkflow}
...
%\end{lstlisting}
\input{api/decision/getWorkflowStep}
...
%\end{lstlisting}
\input{api/decision/getStepCategory}
...
%\end{lstlisting}
\input{api/decision/addTransition}
...
%\end{lstlisting}
\input{api/decision/removeTransition}
...
%\end{lstlisting}
\input{api/decision/deleteWorkflow}
...
%\end{lstlisting}
\input{api/decision/createWorkOrder}
...
%\end{lstlisting}
\input{api/decision/createWorkOrderP}
...
%\end{lstlisting}
\input{api/decision/releaseWorkOrderLock}
...
%\end{lstlisting}
\input{api/decision/getWorkOrderStatus}
...
%\end{lstlisting}
\input{api/decision/writeWorkflowAuditEntry}
...
%\end{lstlisting}
\input{api/decision/getWorkOrdersByDay}


\rule{12cm}{2pt}
\section{GetWorkOrdersByWorkflow}
\index{GetWorkOrdersByWorkflow}
...
\end{Verbatim}
%\begin{lstlisting}[language=reflex]
%ret = #decision.getWorkOrdersByWorkflow(startTimeInstant,workflowUri);
%\end{lstlisting}
\input{api/decision/getWorkOrdersByWorkflow}
...
%\end{lstlisting}
\input{api/decision/getWorkOrder}
...
%\end{lstlisting}
\input{api/decision/cancelWorkOrder}
...
%\end{lstlisting}
\input{api/decision/resumeWorkOrder}
...
%\end{lstlisting}
\input{api/decision/wasCancelCalled}
...
%\end{lstlisting}
\input{api/decision/getCancellationDetails}
...
%\end{lstlisting}
\input{api/decision/getWorkOrderDebug}
...
%\end{lstlisting}
\input{api/decision/setWorkOrderIdGenConfig}
...
%\end{lstlisting}
\input{api/decision/setContextLiteral}
...
%\end{lstlisting}
\input{api/decision/setContextLink}
...
%\end{lstlisting}
\input{api/decision/getContextValue}
...
%\end{lstlisting}
\input{api/decision/addErrorToContext}
...
%\end{lstlisting}
\input{api/decision/getErrorsFromContext}
...
%\end{lstlisting}
\input{api/decision/getExceptionInfo}
...
%\end{lstlisting}
\input{api/decision/reportStepProgress}
...
%\end{lstlisting}
\input{api/decision/getAppStatuses}
...
%\end{lstlisting}
\input{api/decision/getAppStatusDetails}
...
%\end{lstlisting}
\input{api/decision/getMonthlyMetrics}
