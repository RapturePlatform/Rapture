...
%\end{lstlisting}
\input{api/plugin/getInstalledPlugins}
...
%\end{lstlisting}
\input{api/plugin/getPluginManifest}
...
%\end{lstlisting}
\input{api/plugin/installPlugin}
...
%\end{lstlisting}
\input{api/plugin/installPluginItem}
...
%\end{lstlisting}
\input{api/plugin/uninstallPlugin}
...
%\end{lstlisting}
\input{api/plugin/uninstallPluginItem}
...
%\end{lstlisting}
\input{api/plugin/deletePluginManifest}
...
%\end{lstlisting}
\input{api/plugin/getPluginItem}
...
%\end{lstlisting}
\input{api/plugin/createManifest}
...
%\end{lstlisting}
\input{api/plugin/addManifestItem}
...
%\end{lstlisting}
\input{api/plugin/addManifestDataFolder}
...
%\end{lstlisting}
\input{api/plugin/removeManifestDataFolder}
...
%\end{lstlisting}
\input{api/plugin/setManifestVersion}
...
%\end{lstlisting}
\input{api/plugin/removeItemFromManifest}
