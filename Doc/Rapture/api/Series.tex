...
%\end{lstlisting}
\input{api/series/createSeriesRepo}
...
%\end{lstlisting}
\input{api/series/seriesRepoExists}
...
%\end{lstlisting}
\input{api/series/getSeriesRepoConfig}
...
%\end{lstlisting}
\input{api/series/getSeriesRepoConfigs}
...
%\end{lstlisting}
\input{api/series/deleteSeriesRepo}
...
%\end{lstlisting}
\input{api/series/deleteSeriesByUriPrefix}
...
%\end{lstlisting}
\input{api/series/addDoubleToSeries}
...
%\end{lstlisting}
\input{api/series/addLongToSeries}
...
%\end{lstlisting}
\input{api/series/addStringToSeries}
...
%\end{lstlisting}
\input{api/series/addStructureToSeries}
...
%\end{lstlisting}
\input{api/series/addDoublesToSeries}
...
%\end{lstlisting}
\input{api/series/addLongsToSeries}
...
%\end{lstlisting}
\input{api/series/addStringsToSeries}
...
%\end{lstlisting}
\input{api/series/addStructuresToSeries}
...
%\end{lstlisting}
\input{api/series/deletePointsFromSeriesByPointKey}
...
%\end{lstlisting}
\input{api/series/deletePointsFromSeries}
...
%\end{lstlisting}
\input{api/series/getPointsAfter}
...
%\end{lstlisting}
\input{api/series/getPointsAfterReverse}
...
%\end{lstlisting}
\input{api/series/getPointsInRange}
...
%\end{lstlisting}
\input{api/series/getPointsAsDoubles}
...
%\end{lstlisting}
\input{api/series/getPointsAfterAsDoubles}
...
%\end{lstlisting}
\input{api/series/getPointsInRangeAsDoubles}
...
%\end{lstlisting}
\input{api/series/getPointsAsStrings}
...
%\end{lstlisting}
\input{api/series/getPointsAfterAsStrings}
...
%\end{lstlisting}
\input{api/series/getPointsInRangeAsStrings}
...
%\end{lstlisting}
\input{api/series/runSeriesScript}
...
%\end{lstlisting}
\input{api/series/runSeriesScriptQuiet}
...
%\end{lstlisting}
\input{api/series/listSeriesByUriPrefix}
