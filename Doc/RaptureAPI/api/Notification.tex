...
%\end{lstlisting}
\input{api/notification/getNotificationManagerConfigs}
...
%\end{lstlisting}
\input{api/notification/listNotificationsByUriPrefix}
...
%\end{lstlisting}
\input{api/notification/findNotificationManagerConfigsByPurpose}
...
%\end{lstlisting}
\input{api/notification/createNotificationManager}
...
%\end{lstlisting}
\input{api/notification/notificationManagerExists}
...
%\end{lstlisting}
\input{api/notification/getNotificationManagerConfig}
...
%\end{lstlisting}
\input{api/notification/deleteNotificationManager}
...
%\end{lstlisting}
\input{api/notification/getLatestNotificationEpoch}
...
%\end{lstlisting}
\input{api/notification/publishNotification}
...
%\end{lstlisting}
\input{api/notification/findNotificationsAfterEpoch}
...
%\end{lstlisting}
\input{api/notification/getNotification}
