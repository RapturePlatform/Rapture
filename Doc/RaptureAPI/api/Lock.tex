...
%\end{lstlisting}
\input{api/lock/getLockManagerConfigs}
...
%\end{lstlisting}
\input{api/lock/createLockManager}
...
%\end{lstlisting}
\input{api/lock/lockManagerExists}
...
%\end{lstlisting}
\input{api/lock/getLockManagerConfig}
...
%\end{lstlisting}
\input{api/lock/deleteLockManager}
...
%\end{lstlisting}
\input{api/lock/forceReleaseLock}
