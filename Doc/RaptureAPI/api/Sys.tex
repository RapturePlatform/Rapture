...
%\end{lstlisting}
\input{api/sys/retrieveSystemConfig}
...
%\end{lstlisting}
\input{api/sys/writeSystemConfig}
...
%\end{lstlisting}
\input{api/sys/removeSystemConfig}
...
%\end{lstlisting}
\input{api/sys/getSystemFolders}
...
%\end{lstlisting}
\input{api/sys/getAllTopLevelRepos}
...
%\end{lstlisting}
\input{api/sys/getConnectionInfo}
...
%\end{lstlisting}
\input{api/sys/putConnectionInfo}
...
%\end{lstlisting}
\input{api/sys/setConnectionInfo}
