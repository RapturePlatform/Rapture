...
%\end{lstlisting}
\input{api/bootstrap/setEmphemeralRepo}
...
%\end{lstlisting}
\input{api/bootstrap/setConfigRepo}
...
%\end{lstlisting}
\input{api/bootstrap/setSettingsRepo}
...
%\end{lstlisting}
\input{api/bootstrap/migrateConfigRepo}
...
%\end{lstlisting}
\input{api/bootstrap/migrateEphemeralRepo}
...
%\end{lstlisting}
\input{api/bootstrap/migrateSettingsRepo}
...
%\end{lstlisting}
\input{api/bootstrap/getConfigRepo}
...
%\end{lstlisting}
\input{api/bootstrap/getSettingsRepo}
...
%\end{lstlisting}
\input{api/bootstrap/getEphemeralRepo}
...
%\end{lstlisting}
\input{api/bootstrap/restartBootstrap}
...
%\end{lstlisting}
\input{api/bootstrap/addScriptClass}
...
%\end{lstlisting}
\input{api/bootstrap/getScriptClasses}
...
%\end{lstlisting}
\input{api/bootstrap/deleteScriptClass}
